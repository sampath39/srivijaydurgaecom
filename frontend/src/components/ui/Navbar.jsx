  ...
  return (
    <>
      ...
      <div className="bg-gradient-gold text-white text-center text-xs py-1.5 px-4 font-medium">
        🎉 Free shipping on orders above ₹999 | Call us: 9493447776 | Arundelpet, Guntur
      </div>
      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="page-container">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            {/* Home link — desktop */}
            <Link to="/" className="hidden md:block text-gray-700 dark:text-gray-200 hover:text-primary-600 font-medium text-sm transition-colors">
              Home
            </Link>
